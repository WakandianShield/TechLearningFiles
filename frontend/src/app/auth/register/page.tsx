      ...
      <div className="animate-fade-in-up" style={{ width: '100%', maxWidth: '28rem' }}>
        ...
        <div className="card" style={{ padding: '2rem' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <div>
              <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: 'var(--gray-300)', marginBottom: '0.25rem' }}>Nombre</label>
              <input
                type="text"
                className="input"
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: 'var(--gray-300)', marginBottom: '0.25rem' }}>Email</label>
              <input
                type="email"
                className="input"
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: 'var(--gray-300)', marginBottom: '0.25rem' }}>Contraseña</label>
              <input
                type="password"
                className="input"
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: 500, color: 'var(--gray-300)', marginBottom: '0.25rem' }}>Confirmar contraseña</label>
              <input
                type="password"
                className="input"
          ...
          <p style={{ marginTop: '1.5rem', textAlign: 'center', fontSize: '0.875rem', color: 'var(--gray-400)' }}>
            ¿Ya tienes cuenta?{' '}
            <Link href="/auth/login" style={{ color: 'var(--accent-cyan)', fontWeight: 500 }}>
              Inicia sesión
            </Link>
          </p>
        </div>
